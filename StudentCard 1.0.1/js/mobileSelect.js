...
Mobile = function () {
	...
	MobileSelect.prototype = {
		...
		init: function (config) {
			...
			// 	_this.hide();
			// 	//添加部分重新执行一下数据
			// 	var searchIpnVal = document.querySelector('.searchIpt')
			// 	searchIpnVal.value = ''
			...
			_this.cancelBtn.addEventListener('click', function (event) {
				...
				// searchIpnVal.value = ''
				// console.log(searchIpnVal, 'sercancel')
				// mobileSelect5.updateWheels(UplinkData)
				...
				// console.log(window.nullList, '取消敌法给')
				const stuVal = document.querySelector('.stu_box')
				if (!stuVal.textContent) {
			...
			_this.ensureBtn.addEventListener('click', en);
			...
			function en(event) {
				...
				if (nullList[0].uid != 0) {
					// console.log('触发关闭')
					window.chosse = true; //false表示没有选择   true表选择

					//添加部分重新执行一下数据
					var inputVal = document.getElementsByClassName('searchIpt')[0]
					inputVal.value = ''
					// console.log(searchIpnVal.value)
					// console.log(searchIpnVal, 'serchino')

					_this.hide();
					//隐藏提示框
					var Hitmsg = document.querySelectorAll('.hit_msg')
					Hitmsg[2].style.display = 'none'
					...
					for (var i = 0; i < _this.wheel.length; i++) {
						// console.log(_this.wheel.length - 1 == i)
						//
			...
			const laimg = document.querySelector('.laimg')
			...
			_this.trigger.addEventListener('click', function (event) {
				...
				var searchIpnVal = document.querySelector('.searchIpt')
				searchIpnVal.value = ''
				// console.log(searchIpnVal, 'searchIpnVl')
				_this.show();
				//初始化数据
				// console.log(_this)
				// console.log('点击学校蒙层')
		...
		renderWheels: function (wheelsData, cancelBtnText, ensureBtnText) {
			...
			var paren = document.querySelector('.selectContainer')

			var listdom = _this.mobileSelect.querySelectorAll('.selectContainer li')
			var newlistdom = Array.prototype.slice.call(listdom);
			// console.log(newlistdom.length)
			// newlistdom.forEach(element => {
			// 	console.log(element)

			// });


			// newlistdom[newlistdom.length - 1].style.display = 'none'

			// paren.removeChild(newlistdom[newlistdom.length - 1])
